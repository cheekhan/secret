...
import { useSvg, size, branches, jiazi } from './index'
import {
    useRect,
    useStemsPie,
    useGodesPie,
...
function fetchDate() {
    ...
    day_branch.value = z
    // 年干支
    year_gz.value = jiazi.getYear(parseInt(date.value.y))
    // 占时
    index_h.value = useIndexHour()
}
// 起课，根据月将+占时进行计算
const year_gz = ref([0, 0]) // 年的干支
...
<template>
    <div style="display: flex">
        ...
        <div class="svg-right">
            ...
            <!-- 宽度预计450 -->
            <div
                style="width: 450px; padding-left: 55px; box-sizing: border-box"
            >
                <div class="right-row">
                ...
                <div class="right-row" style="justify-content: flex-start">
                    <div>
                        <selectStem :stem="year_gz[0]" />
                        <selectBranch :branche="year_gz[1]" />
                        <span style="margin-left: 10px; margin-right: 65px"
                            >年</span
                        >
                    </div>
                    <div>
                        <selectStem :stem="3" v-model="day_stem" />
                ...
                <div class="right-row" style="justify-content: flex-start">
                    ...
                    <div style="margin-left: 65px">
                        <selectBranch v-model="index_h" :branche="index_h" />
                ...
                <div class="right-row">
                    ...
                    <!-- <div>
                        <span style="margin-left: 30px">占时：</span>
                        <selectBranch v-model="index_h" :branche="index_h" />
                    </div> -->
                </div>
                ...
                <!-- 起课区域 -->
                <p>四课：</p>
                <div class="right-row" style="justify-content: center">
                    <div>
                        <p>财</p>
                        <p>财</p>
                        <p>财</p>
